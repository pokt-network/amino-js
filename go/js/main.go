...
func main() {
	...
	// Typed decoding
	exports.Set("decodePosmintTx", DecodePosmintTx)
	exports.Set("decodePosmintStdSignDoc", DecodePosmintStdSignDoc)
	exports.Set("decodePosmintStdTx", DecodePosmintStdTx)
	...
	exports.Set("decodePosmintEd25519PublicKey", DecodePosmintEd25519PublicKey)
